...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <?php 
                    ...
                    echo '<div class="modal_body mx-3">';
                        ...
                        echo '<div class="escondido">';
                            ...
                            echo form_input(array('type' => 'text','name' => 'id_leccion', 'id' => 'id_leccion', 'value' => $_GET['id_leccion']));
                            echo form_input(array('type' => 'text','name' => 'clave_curso', 'id' => 'clave_curso', 'value' => $_GET['clave_curso']));
                        echo '</div>';
    ...
    <script>
        ...
        var id_leccion = '<?php echo $_GET['id_leccion'];?>';
        var clave_curso = '<?php echo $_GET['clave_curso'];?>';
